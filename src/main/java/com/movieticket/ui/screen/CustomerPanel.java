...
public final class CustomerPanel extends JPanel {
    ...
    private final class MovieBrowseView extends JPanel {
        ...
        private JPanel snackSection() {
            ...
            List<Component> cards = new ArrayList<>();
            cards.add(snackCard(NavIcon.Kind.POPCORN, Ui.ORANGE, "爆米花", "18.00", "大桶 · 约 120g"));
            cards.add(snackCard(NavIcon.Kind.COLA, Ui.LINK, "可乐", "12.00", "中杯 · 500ml"));
            cards.add(snackCard(NavIcon.Kind.FRIES, Ui.GOLD, "薯条", "16.00", "大份 · 约 150g"));
            cards.add(snackCard(NavIcon.Kind.ICE_CREAM, Ui.PURPLE, "冰淇淋", "15.00", "单球 · 90g"));
            cards.add(snackCard(NavIcon.Kind.HOTDOG, Ui.PRIMARY, "热狗", "20.00", "经典 · 含面包"));
         ...
         */
        private JPanel snackCard(NavIcon.Kind icon, Color color, String name,
            ...
            CircleBadge badge = new CircleBadge(color, icon, Color.WHITE, 64);
